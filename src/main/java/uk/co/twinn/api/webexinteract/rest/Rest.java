...
import uk.co.twinn.api.webexinteract.transportation.Http;
...
public class Rest<T> {
   ...
   private final Http<T> http = new Http<>();
    ...
    private List<NameValuePair> getHeaders() {
        ...
        //as per the instructions!!! https://docs.webexinteract.com/reference/intro/authentication
        urlParameters.add(new BasicNameValuePair("X-AUTH-KEY", Configuration.getSecret()));
