...
package uk.co.twinn.api.webexinteract.rest;
...
public class Configuration {
    ...
    public static final String DEFAULT_LOCATION = "/.webexinteract-api/config.json";
     ...
     * </p><p>
     * <i>-as above but use the preset api of /wp-json/wp/v2/ but then this could change in future releases</i><br>
    ...
    public Configuration(String website, String key, String secret, String method){

        this(website, DEFAULT_API, key, secret, false, method);

    }

    public Configuration(String website, String key, String secret, boolean debug, String method){
        this(website, DEFAULT_API, key, secret, debug, method);
    }

    public Configuration(String website, String api, String key, String secret, String method){
        this(website, DEFAULT_API, key, secret, false, method);
    }

    public Configuration(String website, String api, String key, String secret, boolean debug, String method){
    ...
    private Configuration(Builder builder){
        this(builder.website, builder.api, builder.key, builder.secret, builder.debug, builder.method);
    }
